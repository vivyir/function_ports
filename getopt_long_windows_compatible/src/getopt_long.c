// ugly hack  to make the conflicting function error go away
// check getopt.h for more info if you'd like - phnixir
 ...
 */
int getopt_internal(int nargc, char ** nargv, const char *ostr) {
